...
internal struct FileCodeCorner: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.1666666667*width, y: 0.50625*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.6104166667*width, y: 0.9166666667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.9166666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.375*width, y: 0.9166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.5*width, y: 0.7916666667*height))
