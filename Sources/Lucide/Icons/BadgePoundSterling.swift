...
internal struct BadgePoundSterling: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.4166666667*width, y: 0.6666666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.4166666667*width, y: 0.3958333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.5208333333*width, y: 0.2916666667*height), control1: CGPoint(x: 0.4166666667*width, y: 0.3383036719*height), control2: CGPoint(x: 0.4633036719*width, y: 0.2916666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.625*width, y: 0.3958333333*height), control1: CGPoint(x: 0.5783629948*width, y: 0.2916666667*height), control2: CGPoint(x: 0.625*width, y: 0.3383036719*height))
