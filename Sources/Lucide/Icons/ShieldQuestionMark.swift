...
internal struct ShieldQuestionMark: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.3791666667*width, y: 0.375*height))
        strokePath4.addCurve(to: CGPoint(x: 0.5178379054*width, y: 0.2944417236*height), control1: CGPoint(x: 0.3998033935*width, y: 0.3181262767*height), control2: CGPoint(x: 0.4582096685*width, y: 0.2841963221*height))
        strokePath4.addCurve(to: CGPoint(x: 0.6216666667*width, y: 0.4166666667*height), control1: CGPoint(x: 0.5774661424*width, y: 0.3046871252*height), control2: CGPoint(x: 0.6211972811*width, y: 0.3561664636*height))
