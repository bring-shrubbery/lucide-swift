...
internal struct ListCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.625*width, y: 0.75*height))
        strokePath8.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.8333333333*height))
