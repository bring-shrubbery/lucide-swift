...
internal struct FileXCorner: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.625*width, y: 0.7083333333*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.625*width, y: 0.9166666667*height))
