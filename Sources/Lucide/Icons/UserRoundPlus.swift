...
internal struct UserRoundPlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.7916666667*width, y: 0.6666666667*height))
        strokePath5.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.9166666667*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.9166666667*width, y: 0.7916666667*height))
        strokePath7.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.7916666667*height))
