...
internal struct CircleArrowOutDownLeft: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.5*width, y: 0.9166666667*height), control1: CGPoint(x: 0.9166666667*width, y: 0.7301186458*height), control2: CGPoint(x: 0.7301186458*width, y: 0.9166666667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.0833333333*width, y: 0.9166666667*height))
