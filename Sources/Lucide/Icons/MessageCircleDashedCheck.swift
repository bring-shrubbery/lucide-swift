...
internal struct MessageCircleDashedCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath18.move(to: CGPoint(x: 0.6666666667*width, y: 0.375*height))
        strokePath18.addLine(to: CGPoint(x: 0.4375*width, y: 0.6041666667*height))
        strokePath18.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.5*height))
