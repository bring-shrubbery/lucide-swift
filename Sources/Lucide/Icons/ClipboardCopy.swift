...
internal struct ClipboardCopy: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addLine(to: CGPoint(x: 0.8333333333*width, y: 0.75*height))
        ...
        strokePath5.addCurve(to: CGPoint(x: 0.8333333333*width, y: 0.25*height), control1: CGPoint(x: 0.7960237292*width, y: 0.1666666667*height), control2: CGPoint(x: 0.8333333333*width, y: 0.2039762708*height))
        strokePath5.addLine(to: CGPoint(x: 0.8333333333*width, y: 0.4166666667*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.875*width, y: 0.5833333333*height))
        strokePath7.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.5833333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.625*width, y: 0.4166666667*height))
