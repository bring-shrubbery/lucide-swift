...
internal struct OctagonPause: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.10775*width, y: 0.6969166667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.638*width, y: 0.0833333333*height))
