...
internal struct Box: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.9054166667*height))
        ...
        strokePath4.move(to: CGPoint(x: 0.1375*width, y: 0.2916666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.5*width, y: 0.5*height))
        strokePath4.addLine(to: CGPoint(x: 0.8625*width, y: 0.2916666667*height))
