...
internal struct ChartColumnIncreasing: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.5416666667*width, y: 0.7083333333*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.3333333333*width, y: 0.7083333333*height))
