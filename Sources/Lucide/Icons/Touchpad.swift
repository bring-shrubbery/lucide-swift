...
internal struct Touchpad: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.move(to: CGPoint(x: 0.0833333333*width, y: 0.5833333333*height))
        strokePath3.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.5833333333*height))
