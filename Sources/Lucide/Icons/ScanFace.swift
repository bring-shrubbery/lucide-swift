...
internal struct ScanFace: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath10.move(to: CGPoint(x: 0.3333333333*width, y: 0.5833333333*height))
        strokePath10.addCurve(to: CGPoint(x: 0.5*width, y: 0.6666666667*height), control1: CGPoint(x: 0.3333333333*width, y: 0.5833333333*height), control2: CGPoint(x: 0.3958333333*width, y: 0.6666666667*height))
        strokePath10.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.5833333333*height), control1: CGPoint(x: 0.6041666667*width, y: 0.6666666667*height), control2: CGPoint(x: 0.6666666667*width, y: 0.5833333333*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.375*width, y: 0.375*height))
        strokePath12.addLine(to: CGPoint(x: 0.3754166667*width, y: 0.375*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.625*width, y: 0.375*height))
        strokePath14.addLine(to: CGPoint(x: 0.6254166667*width, y: 0.375*height))
