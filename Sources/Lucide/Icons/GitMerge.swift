...
internal struct GitMerge: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.25*width, y: 0.875*height))
        strokePath4.addLine(to: CGPoint(x: 0.25*width, y: 0.375*height))
        strokePath4.addCurve(to: CGPoint(x: 0.625*width, y: 0.75*height), control1: CGPoint(x: 0.25*width, y: 0.5821067812*height), control2: CGPoint(x: 0.4178932188*width, y: 0.75*height))
