...
internal struct FolderSearch2: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath1 = Path()
        strokePath1.addEllipse(in: CGRect(x: 0.375*width, y: 0.4166666667*height, width: 0.2083333333*width, height: 0.2083333333*height))
        ...
        strokePath5.move(to: CGPoint(x: 0.5541666667*width, y: 0.5958333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.625*width, y: 0.6666666667*height))
