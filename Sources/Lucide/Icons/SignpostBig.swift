...
internal struct SignpostBig: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.5*width, y: 0.0833333333*height), control1: CGPoint(x: 0.4166666667*width, y: 0.1206429375*height), control2: CGPoint(x: 0.4539762708*width, y: 0.0833333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.5833333333*width, y: 0.1666666667*height), control1: CGPoint(x: 0.5460237292*width, y: 0.0833333333*height), control2: CGPoint(x: 0.5833333333*width, y: 0.1206429375*height))
