...
internal struct FileSymlink: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.25*width, y: 0.625*height), control1: CGPoint(x: 0.1666666667*width, y: 0.6623096042*height), control2: CGPoint(x: 0.2039762708*width, y: 0.625*height))
        ...
        strokePath6.move(to: CGPoint(x: 0.4166666667*width, y: 0.75*height))
