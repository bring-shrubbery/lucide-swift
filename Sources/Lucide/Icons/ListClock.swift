...
internal struct ListClock: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.6333333333*height))
        strokePath2.addLine(to: CGPoint(x: 0.7333333333*width, y: 0.675*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.125*width, y: 0.5*height))
        strokePath4.addLine(to: CGPoint(x: 0.2690833333*width, y: 0.5*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.125*width, y: 0.7916666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.2846666667*width, y: 0.7916666667*height))
        ...
        strokePath9.addEllipse(in: CGRect(x: 0.4166666667*width, y: 0.375*height, width: 0.5*width, height: 0.5*height))
