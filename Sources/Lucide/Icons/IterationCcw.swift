...
internal struct IterationCcw: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.5*width, y: 0.75*height), control1: CGPoint(x: 0.1666666667*width, y: 0.6007615833*height), control2: CGPoint(x: 0.3159050834*width, y: 0.75*height))
