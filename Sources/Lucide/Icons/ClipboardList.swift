...
internal struct ClipboardList: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.5*width, y: 0.4583333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.4583333333*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.5*width, y: 0.6666666667*height))
        strokePath7.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.6666666667*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.3333333333*width, y: 0.4583333333*height))
        strokePath9.addLine(to: CGPoint(x: 0.33375*width, y: 0.4583333333*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.3333333333*width, y: 0.6666666667*height))
        strokePath11.addLine(to: CGPoint(x: 0.33375*width, y: 0.6666666667*height))
