...
internal struct BadgeSwissFranc: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.4583333333*width, y: 0.7083333333*height))
        strokePath4.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.3333333333*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.6666666667*height))
