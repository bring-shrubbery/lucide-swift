...
internal struct BadgeDollarSign: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.4166666667*width, y: 0.5*height), control1: CGPoint(x: 0.3333333333*width, y: 0.4626903958*height), control2: CGPoint(x: 0.3706429375*width, y: 0.5*height))
        strokePath4.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.5*height))
        strokePath4.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.5833333333*height), control1: CGPoint(x: 0.6293570625*width, y: 0.5*height), control2: CGPoint(x: 0.6666666667*width, y: 0.5373096042*height))
        strokePath4.addCurve(to: CGPoint(x: 0.5833333333*width, y: 0.6666666667*height), control1: CGPoint(x: 0.6666666667*width, y: 0.6293570625*height), control2: CGPoint(x: 0.6293570625*width, y: 0.6666666667*height))
