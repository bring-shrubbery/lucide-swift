...
internal struct FolderOutput: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.0833333333*width, y: 0.3125*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.0833333333*width, y: 0.7708333333*height), control1: CGPoint(x: 0.12768613*width, y: 0.8345667156*height), control2: CGPoint(x: 0.0930638366*width, y: 0.8085999956*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.6666666667*height))
