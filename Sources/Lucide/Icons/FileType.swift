...
internal struct FileType: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addLine(to: CGPoint(x: 0.5*width, y: 0.75*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.375*width, y: 0.5416666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.375*width, y: 0.5208333333*height))
        strokePath10.addCurve(to: CGPoint(x: 0.3958333333*width, y: 0.5*height), control1: CGPoint(x: 0.375*width, y: 0.509327401*height), control2: CGPoint(x: 0.384327401*width, y: 0.5*height))
        strokePath10.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.5*height))
        strokePath10.addCurve(to: CGPoint(x: 0.625*width, y: 0.5208333333*height), control1: CGPoint(x: 0.615672599*width, y: 0.5*height), control2: CGPoint(x: 0.625*width, y: 0.509327401*height))
        strokePath10.addLine(to: CGPoint(x: 0.625*width, y: 0.5416666667*height))
