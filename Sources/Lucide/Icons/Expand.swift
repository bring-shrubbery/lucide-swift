...
internal struct Expand: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.875*width, y: 0.3333333333*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.125*width, y: 0.6666666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.125*width, y: 0.875*height))
        strokePath10.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.875*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.125*width, y: 0.875*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.125*width, y: 0.3333333333*height))
        strokePath14.addLine(to: CGPoint(x: 0.125*width, y: 0.125*height))
        strokePath14.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.125*height))
        ...
        strokePath16.addLine(to: CGPoint(x: 0.125*width, y: 0.125*height))
