...
internal struct DiscAlbum: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addEllipse(in: CGRect(x: 0.2916666667*width, y: 0.2916666667*height, width: 0.4166666667*width, height: 0.4166666667*height))
