...
internal struct FileBraces: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.4166666667*width, y: 0.5*height))
        strokePath6.addCurve(to: CGPoint(x: 0.375*width, y: 0.5416666667*height), control1: CGPoint(x: 0.3936548021*width, y: 0.5*height), control2: CGPoint(x: 0.375*width, y: 0.5186548021*height))
        strokePath6.addLine(to: CGPoint(x: 0.375*width, y: 0.5833333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.3333333333*width, y: 0.625*height), control1: CGPoint(x: 0.375*width, y: 0.6063451979*height), control2: CGPoint(x: 0.3563451979*width, y: 0.625*height))
        strokePath6.addCurve(to: CGPoint(x: 0.375*width, y: 0.6666666667*height), control1: CGPoint(x: 0.3563451979*width, y: 0.625*height), control2: CGPoint(x: 0.375*width, y: 0.6436548021*height))
        strokePath6.addLine(to: CGPoint(x: 0.375*width, y: 0.7083333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4166666667*width, y: 0.75*height), control1: CGPoint(x: 0.375*width, y: 0.7313451979*height), control2: CGPoint(x: 0.3936548021*width, y: 0.75*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.5833333333*width, y: 0.75*height))
        strokePath8.addCurve(to: CGPoint(x: 0.625*width, y: 0.7083333333*height), control1: CGPoint(x: 0.6063451979*width, y: 0.75*height), control2: CGPoint(x: 0.625*width, y: 0.7313451979*height))
        strokePath8.addLine(to: CGPoint(x: 0.625*width, y: 0.6666666667*height))
        strokePath8.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.625*height), control1: CGPoint(x: 0.625*width, y: 0.6436548021*height), control2: CGPoint(x: 0.6436548021*width, y: 0.625*height))
        strokePath8.addCurve(to: CGPoint(x: 0.625*width, y: 0.5833333333*height), control1: CGPoint(x: 0.6436548021*width, y: 0.625*height), control2: CGPoint(x: 0.625*width, y: 0.6063451979*height))
        strokePath8.addLine(to: CGPoint(x: 0.625*width, y: 0.5416666667*height))
        strokePath8.addCurve(to: CGPoint(x: 0.5833333333*width, y: 0.5*height), control1: CGPoint(x: 0.625*width, y: 0.5186548021*height), control2: CGPoint(x: 0.6063451979*width, y: 0.5*height))
