...
internal struct CalendarCheck2: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath10.move(to: CGPoint(x: 0.6666666667*width, y: 0.8333333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.75*width, y: 0.9166666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.75*height))
