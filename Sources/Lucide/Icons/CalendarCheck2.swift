...
internal struct CalendarCheck2: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.875*width, y: 0.5416666667*height))
        ...
        strokePath12.move(to: CGPoint(x: 0.2083333333*width, y: 0.125*height))
        ...
        strokePath14.addLine(to: CGPoint(x: 0.75*width, y: 0.875*height))
        strokePath14.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.7083333333*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.6666666667*width, y: 0.0833333333*height))
        strokePath16.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.2083333333*height))
        ...
        strokePath18.addLine(to: CGPoint(x: 0.875*width, y: 0.375*height))
        ...
        strokePath20.move(to: CGPoint(x: 0.2083333333*width, y: 0.875*height))
        strokePath20.addLine(to: CGPoint(x: 0.5208333333*width, y: 0.875*height))
        ...
        strokePath22.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.2083333333*height))
