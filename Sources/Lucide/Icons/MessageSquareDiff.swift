...
internal struct MessageSquareDiff: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.5*width, y: 0.2916666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.5*width, y: 0.4583333333*height))
