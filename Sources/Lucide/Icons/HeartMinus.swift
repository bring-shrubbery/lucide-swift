...
internal struct HeartMinus: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.6198333333*width, y: 0.79125*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.9065*width, y: 0.4613333333*height), control1: CGPoint(x: 0.9166573139*width, y: 0.4180588823*height), control2: CGPoint(x: 0.9132283078*width, y: 0.4401506756*height))
