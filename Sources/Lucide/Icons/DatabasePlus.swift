...
internal struct DatabasePlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addCurve(to: CGPoint(x: 0.286814581*width, y: 0.6028321294*height), control1: CGPoint(x: 0.1250037026*width, y: 0.5410552348*height), control2: CGPoint(x: 0.1854877451*width, y: 0.5794924563*height))
        strokePath8.addCurve(to: CGPoint(x: 0.6326*width, y: 0.6169208333*height), control1: CGPoint(x: 0.3881414168*width, y: 0.6261718026*height), control2: CGPoint(x: 0.517391203*width, y: 0.6314379644*height))
