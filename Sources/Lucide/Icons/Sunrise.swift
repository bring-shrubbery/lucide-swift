...
internal struct Sunrise: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath14.move(to: CGPoint(x: 0.3333333333*width, y: 0.25*height))
        strokePath14.addLine(to: CGPoint(x: 0.5*width, y: 0.0833333333*height))
        strokePath14.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.25*height))
