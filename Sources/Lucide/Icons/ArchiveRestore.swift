...
internal struct ArchiveRestore: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.8333333333*width, y: 0.3333333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.8333333333*width, y: 0.7916666667*height))
        strokePath5.addCurve(to: CGPoint(x: 0.75*width, y: 0.875*height), control1: CGPoint(x: 0.8333333333*width, y: 0.8376903958*height), control2: CGPoint(x: 0.7960237292*width, y: 0.875*height))
        strokePath5.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.875*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.375*width, y: 0.625*height))
        strokePath7.addLine(to: CGPoint(x: 0.5*width, y: 0.5*height))
        strokePath7.addLine(to: CGPoint(x: 0.625*width, y: 0.625*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.5*width, y: 0.5*height))
        strokePath9.addLine(to: CGPoint(x: 0.5*width, y: 0.875*height))
