...
internal struct UserRoundCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.6666666667*width, y: 0.7916666667*height))
        strokePath5.addLine(to: CGPoint(x: 0.75*width, y: 0.875*height))
        strokePath5.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.7083333333*height))
