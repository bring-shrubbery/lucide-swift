...
internal struct UserRoundPen: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.2270064135*width, y: 0.6008462926*height), control1: CGPoint(x: 0.0833212653*width, y: 0.765572512*height), control2: CGPoint(x: 0.1370186265*width, y: 0.6631084275*height))
        strokePath2.addCurve(to: CGPoint(x: 0.5342083333*width, y: 0.5630416667*height), control1: CGPoint(x: 0.3169942006*width, y: 0.5385841577*height), control2: CGPoint(x: 0.4318099504*width, y: 0.5244547978*height))
        ...
        strokePath5.addEllipse(in: CGRect(x: 0.2083333333*width, y: 0.125*height, width: 0.4166666667*width, height: 0.4166666667*height))
