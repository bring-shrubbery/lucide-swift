...
internal struct CreditCardPlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.9166666667*width, y: 0.4730833333*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.5223333333*width, y: 0.7916666667*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.7916666667*width, y: 0.5833333333*height))
