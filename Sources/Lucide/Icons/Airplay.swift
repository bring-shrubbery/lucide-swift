...
internal struct Airplay: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.2083333333*width, y: 0.7083333333*height))
        strokePath2.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.7083333333*height))
        strokePath2.addCurve(to: CGPoint(x: 0.0833333333*width, y: 0.625*height), control1: CGPoint(x: 0.1206429375*width, y: 0.7083333333*height), control2: CGPoint(x: 0.0833333333*width, y: 0.6710237292*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.8333333333*width, y: 0.7083333333*height), control1: CGPoint(x: 0.9166666667*width, y: 0.6710237292*height), control2: CGPoint(x: 0.8793570625*width, y: 0.7083333333*height))
