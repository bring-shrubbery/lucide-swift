...
internal struct MailX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.9166666667*width, y: 0.5221666667*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.533*width, y: 0.8333333333*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.9166666667*width, y: 0.2916666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.5420416667*width, y: 0.5302916667*height))
        strokePath4.addCurve(to: CGPoint(x: 0.4583333333*width, y: 0.5302916667*height), control1: CGPoint(x: 0.5161631146*width, y: 0.5453225041*height), control2: CGPoint(x: 0.4842118854*width, y: 0.5453225041*height))
        strokePath4.addLine(to: CGPoint(x: 0.0833333333*width, y: 0.2916666667*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.6875*width, y: 0.6875*height))
        strokePath6.addLine(to: CGPoint(x: 0.8958333333*width, y: 0.8958333333*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.8958333333*width, y: 0.6875*height))
        strokePath8.addLine(to: CGPoint(x: 0.6875*width, y: 0.8958333333*height))
