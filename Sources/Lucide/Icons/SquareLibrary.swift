...
internal struct SquareLibrary: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addLine(to: CGPoint(x: 0.2916666667*width, y: 0.7083333333*height))
        ...
        strokePath7.move(to: CGPoint(x: 0.625*width, y: 0.2916666667*height))
        strokePath7.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.7083333333*height))
