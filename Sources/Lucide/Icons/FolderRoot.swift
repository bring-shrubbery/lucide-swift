...
internal struct FolderRoot: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addEllipse(in: CGRect(x: 0.4166666667*width, y: 0.4583333333*height, width: 0.1666666667*width, height: 0.1666666667*height))
        path.addPath(strokePath3.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath5 = Path()
        strokePath5.move(to: CGPoint(x: 0.5*width, y: 0.625*height))
