...
internal struct CalendarCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath9.move(to: CGPoint(x: 0.375*width, y: 0.625*height))
        strokePath9.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.7083333333*height))
        strokePath9.addLine(to: CGPoint(x: 0.625*width, y: 0.5416666667*height))
