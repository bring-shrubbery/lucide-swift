...
internal struct FolderSymlink: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.0833333333*width, y: 0.3895833333*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.1666666667*width, y: 0.5416666667*height), control1: CGPoint(x: 0.0833333333*width, y: 0.5789762708*height), control2: CGPoint(x: 0.1206429375*width, y: 0.5416666667*height))
