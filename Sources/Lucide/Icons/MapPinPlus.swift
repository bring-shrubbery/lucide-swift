...
internal struct MapPinPlus: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.82975*width, y: 0.4627083333*height))
        strokePath2.addCurve(to: CGPoint(x: 0.8333333333*width, y: 0.4166666667*height), control1: CGPoint(x: 0.8321097878*width, y: 0.4474741292*height), control2: CGPoint(x: 0.8333076858*width, y: 0.4320825324*height))
        ...
        strokePath7.move(to: CGPoint(x: 0.7916666667*width, y: 0.625*height))
