...
internal struct Maximize: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.875*height))
        strokePath8.addCurve(to: CGPoint(x: 0.875*width, y: 0.7916666667*height), control1: CGPoint(x: 0.8376903958*width, y: 0.875*height), control2: CGPoint(x: 0.875*width, y: 0.8376903958*height))
