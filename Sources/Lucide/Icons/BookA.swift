...
internal struct BookA: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.3791666667*width, y: 0.4583333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.6166666667*width, y: 0.4583333333*height))
