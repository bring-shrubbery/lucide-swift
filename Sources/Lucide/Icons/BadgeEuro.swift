...
internal struct BadgeEuro: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.625*width, y: 0.3916666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4406013588*width, y: 0.3436557303*height), control1: CGPoint(x: 0.5796444135*width, y: 0.3386401102*height), control2: CGPoint(x: 0.5060575376*width, y: 0.3194806696*height))
        strokePath6.addCurve(to: CGPoint(x: 0.3316776321*width, y: 0.5*height), control1: CGPoint(x: 0.3751451799*width, y: 0.367830791*height), control2: CGPoint(x: 0.3316776321*width, y: 0.4302221746*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4406013588*width, y: 0.6563442697*height), control1: CGPoint(x: 0.3316776321*width, y: 0.5697778254*height), control2: CGPoint(x: 0.3751451799*width, y: 0.632169209*height))
        strokePath6.addCurve(to: CGPoint(x: 0.625*width, y: 0.6083333333*height), control1: CGPoint(x: 0.5060575376*width, y: 0.6805193304*height), control2: CGPoint(x: 0.5796444135*width, y: 0.6613598898*height))
