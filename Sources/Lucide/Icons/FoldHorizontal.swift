...
internal struct FoldHorizontal: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath14.move(to: CGPoint(x: 0.7916666667*width, y: 0.375*height))
        strokePath14.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.5*height))
        strokePath14.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.625*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.2083333333*width, y: 0.625*height))
        strokePath16.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.5*height))
        strokePath16.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.375*height))
