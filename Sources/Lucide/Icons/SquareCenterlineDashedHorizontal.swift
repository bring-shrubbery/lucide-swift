...
internal struct SquareCenterlineDashedHorizontal: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.2083333333*width, y: 0.875*height), control1: CGPoint(x: 0.125*width, y: 0.8375*height), control2: CGPoint(x: 0.1625*width, y: 0.875*height))
