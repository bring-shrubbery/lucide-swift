...
internal struct BookUp2: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.375*width, y: 0.4166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.5*width, y: 0.2916666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.625*width, y: 0.4166666667*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.375*width, y: 0.2083333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.5*width, y: 0.0833333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.625*width, y: 0.2083333333*height))
