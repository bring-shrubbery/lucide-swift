...
internal struct FileChartColumnIncreasing: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath10.move(to: CGPoint(x: 0.6666666667*width, y: 0.75*height))
        strokePath10.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.5*height))
