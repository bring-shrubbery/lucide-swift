...
internal struct Columns3Cog: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.4416666667*width, y: 0.875*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.875*width, y: 0.4416666667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.625*width, y: 0.4416666667*height))
        ...
        strokePath12.move(to: CGPoint(x: 0.7021666667*width, y: 0.8655*height))
        strokePath12.addLine(to: CGPoint(x: 0.6862083333*width, y: 0.904*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.81375*width, y: 0.904*height))
        strokePath16.addLine(to: CGPoint(x: 0.7978333333*width, y: 0.8655*height))
        ...
        strokePath22.move(to: CGPoint(x: 0.375*width, y: 0.125*height))
        strokePath22.addLine(to: CGPoint(x: 0.375*width, y: 0.875*height))
