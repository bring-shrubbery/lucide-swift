...
internal struct Columns3Cog: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.4375*width, y: 0.875*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.875*width, y: 0.4375*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.5958333333*width, y: 0.8166666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.6375*width, y: 0.8*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.625*width, y: 0.125*height))
        strokePath6.addLine(to: CGPoint(x: 0.625*width, y: 0.4375*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.6333333333*width, y: 0.7041666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.5958333333*width, y: 0.6916666667*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.6916666667*width, y: 0.9041666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.7041666667*width, y: 0.8666666667*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.7*width, y: 0.6375*height))
        strokePath12.addLine(to: CGPoint(x: 0.6833333333*width, y: 0.5958333333*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.7958333333*width, y: 0.6333333333*height))
        strokePath14.addLine(to: CGPoint(x: 0.8083333333*width, y: 0.5958333333*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.8166666667*width, y: 0.9041666667*height))
        strokePath16.addLine(to: CGPoint(x: 0.8*width, y: 0.8625*height))
        ...
        strokePath18.move(to: CGPoint(x: 0.8625*width, y: 0.7*height))
        strokePath18.addLine(to: CGPoint(x: 0.9041666667*width, y: 0.6833333333*height))
        ...
        strokePath20.move(to: CGPoint(x: 0.9041666667*width, y: 0.8083333333*height))
        strokePath20.addLine(to: CGPoint(x: 0.8666666667*width, y: 0.7958333333*height))
