...
internal struct BookmarkCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.7916666667*width, y: 0.2083333333*height), control1: CGPoint(x: 0.7543570625*width, y: 0.125*height), control2: CGPoint(x: 0.7916666667*width, y: 0.1623096042*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.2916666667*width, y: 0.125*height), control1: CGPoint(x: 0.2083333333*width, y: 0.1623096042*height), control2: CGPoint(x: 0.2456429375*width, y: 0.125*height))
