...
internal struct Angle: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.5416666667*width, y: 0.875*height), control1: CGPoint(x: 0.3551186458*width, y: 0.4583333333*height), control2: CGPoint(x: 0.5416666667*width, y: 0.6448813542*height))
