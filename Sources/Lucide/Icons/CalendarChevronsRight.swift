...
internal struct CalendarChevronsRight: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addCurve(to: CGPoint(x: 0.7916666667*width, y: 0.125*height), control1: CGPoint(x: 0.875*width, y: 0.1623096042*height), control2: CGPoint(x: 0.8376903958*width, y: 0.125*height))
        strokePath8.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.125*height))
