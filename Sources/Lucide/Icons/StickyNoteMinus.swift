...
internal struct StickyNoteMinus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.8455833333*width, y: 0.3039166667*height), control1: CGPoint(x: 0.8750654034*width, y: 0.3483309217*height), control2: CGPoint(x: 0.8644752568*width, y: 0.3227405675*height))
        strokePath4.addLine(to: CGPoint(x: 0.6960833333*width, y: 0.1544166667*height))
        strokePath4.addCurve(to: CGPoint(x: 0.625*width, y: 0.125*height), control1: CGPoint(x: 0.6772594325*width, y: 0.1355247432*height), control2: CGPoint(x: 0.6516690783*width, y: 0.1249345966*height))
        ...
        strokePath4.addLine(to: CGPoint(x: 0.5145833333*width, y: 0.875*height))
