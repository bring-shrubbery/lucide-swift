...
internal struct Shredder: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath14.move(to: CGPoint(x: 0.25*width, y: 0.8333333333*height))
