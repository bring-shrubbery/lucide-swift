...
internal struct FilePlay: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.626375*width, y: 0.56*height))
        strokePath6.addCurve(to: CGPoint(x: 0.6398312116*width, y: 0.5833333333*height), control1: CGPoint(x: 0.6347029989*width, y: 0.5648190995*height), control2: CGPoint(x: 0.6398312116*width, y: 0.5737115203*height))
        strokePath6.addCurve(to: CGPoint(x: 0.626375*width, y: 0.6066666667*height), control1: CGPoint(x: 0.6398312116*width, y: 0.5929551464*height), control2: CGPoint(x: 0.6347029989*width, y: 0.6018475672*height))
        strokePath6.addLine(to: CGPoint(x: 0.457*width, y: 0.7046666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4300838023*width, y: 0.7046670465*height), control1: CGPoint(x: 0.4486744507*width, y: 0.7094834137*height), control2: CGPoint(x: 0.4384094875*width, y: 0.7094835586*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4166666667*width, y: 0.6813333333*height), control1: CGPoint(x: 0.4217581171*width, y: 0.6998505344*height), control2: CGPoint(x: 0.4166412575*width, y: 0.6909518143*height))
        strokePath6.addLine(to: CGPoint(x: 0.4166666667*width, y: 0.4853333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4300734319*width, y: 0.4620297402*height), control1: CGPoint(x: 0.4166499007*width, y: 0.4757277434*height), control2: CGPoint(x: 0.4217610778*width, y: 0.466843513*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4569583333*width, y: 0.462*height), control1: CGPoint(x: 0.438385786*width, y: 0.4572159674*height), control2: CGPoint(x: 0.4486353496*width, y: 0.4572046293*height))
