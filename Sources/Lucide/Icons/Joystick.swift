...
internal struct Joystick: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.7916666667*width, y: 0.625*height), control1: CGPoint(x: 0.875*width, y: 0.6623096042*height), control2: CGPoint(x: 0.8376903958*width, y: 0.625*height))
        strokePath2.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.625*height))
        strokePath2.addCurve(to: CGPoint(x: 0.125*width, y: 0.7083333333*height), control1: CGPoint(x: 0.1623096042*width, y: 0.625*height), control2: CGPoint(x: 0.125*width, y: 0.6623096042*height))
        ...
        strokePath4.addLine(to: CGPoint(x: 0.25*width, y: 0.5416666667*height))
        ...
        strokePath7.addEllipse(in: CGRect(x: 0.375*width, y: 0.125*height, width: 0.25*width, height: 0.25*height))
