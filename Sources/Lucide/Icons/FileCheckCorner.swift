...
internal struct FileCheckCorner: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.4375*width, y: 0.9166666667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.9166666667*height))
