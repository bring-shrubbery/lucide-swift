...
internal struct CloudHail: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.6666666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.6666666667*width, y: 0.8333333333*height))
        strokePath8.addLine(to: CGPoint(x: 0.6670833333*width, y: 0.8333333333*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.3333333333*width, y: 0.8333333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.33375*width, y: 0.8333333333*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.5*width, y: 0.6666666667*height))
        strokePath12.addLine(to: CGPoint(x: 0.5*width, y: 0.75*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.5*width, y: 0.9166666667*height))
        strokePath14.addLine(to: CGPoint(x: 0.5004166667*width, y: 0.9166666667*height))
