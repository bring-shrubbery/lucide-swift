...
internal struct CloudDrizzle: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath14.move(to: CGPoint(x: 0.5*width, y: 0.6666666667*height))
        strokePath14.addLine(to: CGPoint(x: 0.5*width, y: 0.7083333333*height))
