...
internal struct FileLock: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.1666666667*width, y: 0.4083333333*height))
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.2916666667*width, y: 0.5416666667*height), control1: CGPoint(x: 0.375*width, y: 0.5789762708*height), control2: CGPoint(x: 0.3376903958*width, y: 0.5416666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.2083333333*width, y: 0.625*height), control1: CGPoint(x: 0.2456429375*width, y: 0.5416666667*height), control2: CGPoint(x: 0.2083333333*width, y: 0.5789762708*height))
        strokePath6.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.7083333333*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.addRoundedRect(in: CGRect(x: 0.125*width, y: 0.7083333333*height, width: 0.3333333333*width, height: 0.2083333333*height), cornerSize: CGSize(width: 0.0416666667*width, height: 0.0416666667*height))
