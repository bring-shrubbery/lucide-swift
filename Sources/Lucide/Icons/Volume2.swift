...
internal struct Volume2: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.625*height), control1: CGPoint(x: 0.7222222222*width, y: 0.4490740741*height), control2: CGPoint(x: 0.7222222222*width, y: 0.5509259259*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.8068333333*width, y: 0.7651666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.9166699141*width, y: 0.5*height), control1: CGPoint(x: 0.8771604685*width, y: 0.6948403927*height), control2: CGPoint(x: 0.9166699141*width, y: 0.5994569794*height))
        strokePath6.addCurve(to: CGPoint(x: 0.8068333333*width, y: 0.2348333333*height), control1: CGPoint(x: 0.9166699141*width, y: 0.4005430206*height), control2: CGPoint(x: 0.8771604685*width, y: 0.3051596073*height))
