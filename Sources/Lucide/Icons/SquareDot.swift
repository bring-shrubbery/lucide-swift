...
internal struct SquareDot: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addEllipse(in: CGRect(x: 0.4583333333*width, y: 0.4583333333*height, width: 0.0833333333*width, height: 0.0833333333*height))
