...
internal struct SpellCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.8333333333*width, y: 0.625*height))
        strokePath2.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.8541666667*height))
        ...
        strokePath4.addLine(to: CGPoint(x: 0.6297916667*width, y: 0.5929166667*height))
