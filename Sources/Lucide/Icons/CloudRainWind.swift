...
internal struct CloudRainWind: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.3833333333*width, y: 0.9166666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.5083333333*width, y: 0.625*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.8333333333*height))
