...
internal struct ExternalLink: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.875*height), control1: CGPoint(x: 0.75*width, y: 0.8376903958*height), control2: CGPoint(x: 0.7126903958*width, y: 0.875*height))
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.2083333333*width, y: 0.25*height), control1: CGPoint(x: 0.125*width, y: 0.2873096042*height), control2: CGPoint(x: 0.1623096042*width, y: 0.25*height))
        strokePath6.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.25*height))
