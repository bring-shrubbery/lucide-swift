...
internal struct Videotape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.move(to: CGPoint(x: 0.0833333333*width, y: 0.3333333333*height))
        strokePath3.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.3333333333*height))
        path.addPath(strokePath3.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.addEllipse(in: CGRect(x: 0.25*width, y: 0.5*height, width: 0.1666666667*width, height: 0.1666666667*height))
        ...
        strokePath7.addEllipse(in: CGRect(x: 0.5833333333*width, y: 0.5*height, width: 0.1666666667*width, height: 0.1666666667*height))
