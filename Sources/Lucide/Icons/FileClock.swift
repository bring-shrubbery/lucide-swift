...
internal struct FileClock: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.2854166667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.675*height))
        strokePath6.addLine(to: CGPoint(x: 0.4*width, y: 0.7166666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.addEllipse(in: CGRect(x: 0.0833333333*width, y: 0.4166666667*height, width: 0.5*width, height: 0.5*height))
