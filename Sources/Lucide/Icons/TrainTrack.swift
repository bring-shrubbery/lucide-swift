...
internal struct TrainTrack: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.7916666667*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.4583333333*width, y: 0.2083333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.5416666667*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.5833333333*width, y: 0.0833333333*height))
        strokePath12.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.4166666667*height))
        ...
        strokePath14.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.2916666667*height))
