...
internal struct Loader: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.675*width, y: 0.325*height))
        strokePath4.addLine(to: CGPoint(x: 0.7958333333*width, y: 0.2041666667*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.675*width, y: 0.675*height))
        strokePath8.addLine(to: CGPoint(x: 0.7958333333*width, y: 0.7958333333*height))
        ...
        strokePath12.move(to: CGPoint(x: 0.2041666667*width, y: 0.7958333333*height))
        strokePath12.addLine(to: CGPoint(x: 0.325*width, y: 0.675*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.2041666667*width, y: 0.2041666667*height))
        strokePath16.addLine(to: CGPoint(x: 0.325*width, y: 0.325*height))
