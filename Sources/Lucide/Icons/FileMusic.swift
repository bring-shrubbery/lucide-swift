...
internal struct FileMusic: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.4854166667*width, y: 0.9166666667*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.5979166667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.6030833333*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.addEllipse(in: CGRect(x: 0.1666666667*width, y: 0.75*height, width: 0.1666666667*width, height: 0.1666666667*height))
