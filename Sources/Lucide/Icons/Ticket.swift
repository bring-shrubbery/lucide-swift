...
internal struct Ticket: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.5416666667*width, y: 0.7083333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.7916666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.5416666667*width, y: 0.4583333333*height))
        strokePath8.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.5416666667*height))
