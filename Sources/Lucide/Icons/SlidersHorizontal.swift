...
internal struct SlidersHorizontal: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.6666666667*width, y: 0.7083333333*height))
        ...
        strokePath12.move(to: CGPoint(x: 0.875*width, y: 0.7916666667*height))
        strokePath12.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.7916666667*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.875*width, y: 0.2083333333*height))
        strokePath14.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.2083333333*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.3333333333*width, y: 0.4166666667*height))
        strokePath16.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.5833333333*height))
        ...
        strokePath18.addLine(to: CGPoint(x: 0.125*width, y: 0.5*height))
