...
internal struct SquareArrowRight: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.move(to: CGPoint(x: 0.3333333333*width, y: 0.5*height))
        strokePath3.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.5*height))
        path.addPath(strokePath3.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath5 = Path()
        strokePath5.move(to: CGPoint(x: 0.5*width, y: 0.6666666667*height))
        strokePath5.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.5*height))
        strokePath5.addLine(to: CGPoint(x: 0.5*width, y: 0.3333333333*height))
