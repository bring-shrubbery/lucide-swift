...
internal struct StickyNotePlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.5148333333*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.5147916667*width, y: 0.875*height))
