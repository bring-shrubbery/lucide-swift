...
internal struct FileArchive: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.569125*width, y: 0.9166666667*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.6458333333*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.3333333333*width, y: 0.2916666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.25*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath11 = Path()
        strokePath11.addEllipse(in: CGRect(x: 0.25*width, y: 0.75*height, width: 0.1666666667*width, height: 0.1666666667*height))
