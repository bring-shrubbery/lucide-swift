...
internal struct SlidersVertical: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.7083333333*width, y: 0.6666666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.875*width, y: 0.6666666667*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.7916666667*width, y: 0.5*height))
        strokePath10.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.125*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.7916666667*width, y: 0.875*height))
        strokePath12.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.6666666667*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.125*width, y: 0.5833333333*height))
        strokePath14.addLine(to: CGPoint(x: 0.2916666667*width, y: 0.5833333333*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.2083333333*width, y: 0.4166666667*height))
        strokePath16.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.125*height))
        ...
        strokePath18.move(to: CGPoint(x: 0.2083333333*width, y: 0.875*height))
        strokePath18.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.5833333333*height))
