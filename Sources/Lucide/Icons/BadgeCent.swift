...
internal struct BadgeCent: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.6416666667*width, y: 0.4166666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4541925919*width, y: 0.3390123623*height), control1: CGPoint(x: 0.6039495268*width, y: 0.3513386641*height), control2: CGPoint(x: 0.5270565108*width, y: 0.319488534*height))
        strokePath6.addCurve(to: CGPoint(x: 0.3306624327*width, y: 0.5*height), control1: CGPoint(x: 0.3813286729*width, y: 0.3585361905*height), control2: CGPoint(x: 0.3306624327*width, y: 0.4245657203*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4541925919*width, y: 0.6609876377*height), control1: CGPoint(x: 0.3306624327*width, y: 0.5754342797*height), control2: CGPoint(x: 0.3813286729*width, y: 0.6414638095*height))
        strokePath6.addCurve(to: CGPoint(x: 0.6416666667*width, y: 0.5833333333*height), control1: CGPoint(x: 0.5270565108*width, y: 0.680511466*height), control2: CGPoint(x: 0.6039495268*width, y: 0.6486613359*height))
