...
internal struct CalendarX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath9.move(to: CGPoint(x: 0.5833333333*width, y: 0.5416666667*height))
        strokePath9.addLine(to: CGPoint(x: 0.4166666667*width, y: 0.7083333333*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.4166666667*width, y: 0.5416666667*height))
        strokePath11.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.7083333333*height))
