...
internal struct Phi: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addEllipse(in: CGRect(x: 0.2083333333*width, y: 0.2083333333*height, width: 0.5833333333*width, height: 0.5833333333*height))
