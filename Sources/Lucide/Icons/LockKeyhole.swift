...
internal struct LockKeyhole: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.5*width, y: 0.0833333333*height), control1: CGPoint(x: 0.2916666667*width, y: 0.1766073438*height), control2: CGPoint(x: 0.3849406771*width, y: 0.0833333333*height))
        strokePath4.addCurve(to: CGPoint(x: 0.7083333333*width, y: 0.2916666667*height), control1: CGPoint(x: 0.6150593229*width, y: 0.0833333333*height), control2: CGPoint(x: 0.7083333333*width, y: 0.1766073438*height))
