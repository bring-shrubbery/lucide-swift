...
internal struct BatteryFull: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath9.addRoundedRect(in: CGRect(x: 0.0833333333*width, y: 0.25*height, width: 0.6666666667*width, height: 0.5*height), cornerSize: CGSize(width: 0.0833333333*width, height: 0.0833333333*height))
