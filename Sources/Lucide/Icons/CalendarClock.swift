...
internal struct CalendarClock: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.30575*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.30575*width, y: 0.875*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.125*width, y: 0.375*height))
        strokePath8.addLine(to: CGPoint(x: 0.369125*width, y: 0.375*height))
        ...
        strokePath11.addEllipse(in: CGRect(x: 0.4166666667*width, y: 0.4166666667*height, width: 0.5*width, height: 0.5*height))
