...
internal struct MessageSquareX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.6041666667*width, y: 0.3541666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.3958333333*width, y: 0.5625*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.3958333333*width, y: 0.3541666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.5625*height))
