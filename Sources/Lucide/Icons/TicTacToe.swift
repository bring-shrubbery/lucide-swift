...
internal struct TicTacToe: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.9166666667*width, y: 0.5*height))
        strokePath8.addLine(to: CGPoint(x: 0.0833333333*width, y: 0.5*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.3333333333*width, y: 0.125*height))
        strokePath10.addLine(to: CGPoint(x: 0.125*width, y: 0.3333333333*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.3333333333*width, y: 0.3333333333*height))
        strokePath12.addLine(to: CGPoint(x: 0.125*width, y: 0.125*height))
        ...
        strokePath13.addEllipse(in: CGRect(x: 0.6666666667*width, y: 0.125*height, width: 0.2083333333*width, height: 0.2083333333*height))
        ...
        strokePath14.addEllipse(in: CGRect(x: 0.125*width, y: 0.6666666667*height, width: 0.2083333333*width, height: 0.2083333333*height))
