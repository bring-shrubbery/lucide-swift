...
internal struct ShieldBan: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.1767916667*width, y: 0.2170833333*height))
        strokePath4.addLine(to: CGPoint(x: 0.776375*width, y: 0.73675*height))
