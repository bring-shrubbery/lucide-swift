...
internal struct FileTypeCorner: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.125*width, y: 0.6041666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.1458333333*width, y: 0.5833333333*height), control1: CGPoint(x: 0.125*width, y: 0.5926607344*height), control2: CGPoint(x: 0.134327401*width, y: 0.5833333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.4375*width, y: 0.5833333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.4583333333*width, y: 0.6041666667*height), control1: CGPoint(x: 0.4490059323*width, y: 0.5833333333*height), control2: CGPoint(x: 0.4583333333*width, y: 0.5926607344*height))
        strokePath6.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.6666666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.25*width, y: 0.9166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.9166666667*height))
