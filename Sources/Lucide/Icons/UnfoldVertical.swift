...
internal struct UnfoldVertical: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.1666666667*width, y: 0.5*height))
        strokePath6.addLine(to: CGPoint(x: 0.0833333333*width, y: 0.5*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.4166666667*width, y: 0.5*height))
        strokePath8.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.5*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.6666666667*width, y: 0.5*height))
        strokePath10.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.5*height))
        ...
        strokePath14.addLine(to: CGPoint(x: 0.5*width, y: 0.9166666667*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.625*width, y: 0.2083333333*height))
        strokePath16.addLine(to: CGPoint(x: 0.5*width, y: 0.0833333333*height))
        strokePath16.addLine(to: CGPoint(x: 0.375*width, y: 0.2083333333*height))
