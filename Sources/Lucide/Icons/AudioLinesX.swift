...
internal struct AudioLinesX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.5979166667*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.75*width, y: 0.5458333333*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.9166666667*width, y: 0.7083333333*height))
        ...
        strokePath16.move(to: CGPoint(x: 0.25*width, y: 0.25*height))
        strokePath16.addLine(to: CGPoint(x: 0.25*width, y: 0.7083333333*height))
