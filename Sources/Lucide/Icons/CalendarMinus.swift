...
internal struct CalendarMinus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.5833333333*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.5541666667*width, y: 0.875*height))
