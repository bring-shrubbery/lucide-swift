...
internal struct Film: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.125*width, y: 0.3125*height))
        strokePath5.addLine(to: CGPoint(x: 0.2916666667*width, y: 0.3125*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.125*width, y: 0.5*height))
        strokePath7.addLine(to: CGPoint(x: 0.875*width, y: 0.5*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.125*width, y: 0.6875*height))
        strokePath9.addLine(to: CGPoint(x: 0.2916666667*width, y: 0.6875*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.7083333333*width, y: 0.125*height))
        strokePath11.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.875*height))
        ...
        strokePath13.move(to: CGPoint(x: 0.7083333333*width, y: 0.3125*height))
        strokePath13.addLine(to: CGPoint(x: 0.875*width, y: 0.3125*height))
        ...
        strokePath15.move(to: CGPoint(x: 0.7083333333*width, y: 0.6875*height))
        strokePath15.addLine(to: CGPoint(x: 0.875*width, y: 0.6875*height))
