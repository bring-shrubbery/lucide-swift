...
internal struct CornerUpRight: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.3333333333*width, y: 0.375*height), control1: CGPoint(x: 0.1666666667*width, y: 0.4496192084*height), control2: CGPoint(x: 0.241285875*width, y: 0.375*height))
