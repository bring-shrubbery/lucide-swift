...
internal struct FileText: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.375*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.6666666667*width, y: 0.7083333333*height))
