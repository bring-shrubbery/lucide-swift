...
internal struct ChevronsLeftRightEllipsis: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addLine(to: CGPoint(x: 0.6670833333*width, y: 0.5*height))
        ...
        strokePath10.addLine(to: CGPoint(x: 0.33375*width, y: 0.5*height))
