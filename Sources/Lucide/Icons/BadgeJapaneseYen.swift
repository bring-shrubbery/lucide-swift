...
internal struct BadgeJapaneseYen: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.5*width, y: 0.4583333333*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.625*width, y: 0.5*height))
