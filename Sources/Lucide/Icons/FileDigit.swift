...
internal struct FileDigit: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.4166666667*width, y: 0.9166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.9166666667*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.addRoundedRect(in: CGRect(x: 0.0833333333*width, y: 0.6666666667*height, width: 0.1666666667*width, height: 0.25*height), cornerSize: CGSize(width: 0.0833333333*width, height: 0.0833333333*height))
