...
internal struct DoorClosedLocked: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.7916666667*width, y: 0.3333333333*height))
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.75*width, y: 0.5*height), control1: CGPoint(x: 0.8333333333*width, y: 0.5373096042*height), control2: CGPoint(x: 0.7960237292*width, y: 0.5*height))
        strokePath6.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.5833333333*height), control1: CGPoint(x: 0.7039762708*width, y: 0.5*height), control2: CGPoint(x: 0.6666666667*width, y: 0.5373096042*height))
        ...
        strokePath9.addRoundedRect(in: CGRect(x: 0.5833333333*width, y: 0.6666666667*height, width: 0.3333333333*width, height: 0.2083333333*height), cornerSize: CGSize(width: 0.0416666667*width, height: 0.0416666667*height))
