...
internal struct SquareArrowRightExit: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.2643333333*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.875*width, y: 0.7356666667*height))
