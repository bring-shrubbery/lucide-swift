...
internal struct ArrowDownWideNarrow: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.875*width, y: 0.1666666667*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.4583333333*width, y: 0.5*height))
