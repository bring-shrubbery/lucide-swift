...
internal struct BookHeadphones: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.5*width, y: 0.25*height), control1: CGPoint(x: 0.3333333333*width, y: 0.3246192084*height), control2: CGPoint(x: 0.4079525417*width, y: 0.25*height))
        strokePath4.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.4166666667*height), control1: CGPoint(x: 0.5920474583*width, y: 0.25*height), control2: CGPoint(x: 0.6666666667*width, y: 0.3246192084*height))
