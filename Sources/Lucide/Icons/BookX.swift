...
internal struct BookX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.6041666667*width, y: 0.2916666667*height))
        strokePath2.addLine(to: CGPoint(x: 0.3958333333*width, y: 0.5*height))
        ...
        strokePath6.move(to: CGPoint(x: 0.3958333333*width, y: 0.2916666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.5*height))
