...
internal struct MessageSquareReply: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.625*width, y: 0.4583333333*height), control1: CGPoint(x: 0.7083333333*width, y: 0.4956429375*height), control2: CGPoint(x: 0.6710237292*width, y: 0.4583333333*height))
