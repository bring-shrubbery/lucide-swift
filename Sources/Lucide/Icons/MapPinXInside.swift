...
internal struct MapPinXInside: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.6041666667*width, y: 0.3125*height))
        strokePath4.addLine(to: CGPoint(x: 0.3958333333*width, y: 0.5208333333*height))
