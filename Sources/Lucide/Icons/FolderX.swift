...
internal struct FolderX: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.8333333333*width, y: 0.8333333333*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.5041666667*width, y: 0.25*height))
        strokePath2.addCurve(to: CGPoint(x: 0.43375*width, y: 0.2125*height), control1: CGPoint(x: 0.4758471914*width, y: 0.250277649*height), control2: CGPoint(x: 0.4493250989*width, y: 0.2361534577*height))
        strokePath2.addLine(to: CGPoint(x: 0.4*width, y: 0.1625*height))
        strokePath2.addCurve(to: CGPoint(x: 0.3304166667*width, y: 0.125*height), control1: CGPoint(x: 0.3845865638*width, y: 0.1390949862*height), control2: CGPoint(x: 0.3584410965*width, y: 0.1250046146*height))
        ...
        strokePath4.move(to: CGPoint(x: 0.3958333333*width, y: 0.4375*height))
        strokePath4.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.6458333333*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.6041666667*width, y: 0.4375*height))
        strokePath6.addLine(to: CGPoint(x: 0.3958333333*width, y: 0.6458333333*height))
