...
internal struct ScanSearch: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath9.addEllipse(in: CGRect(x: 0.375*width, y: 0.375*height, width: 0.25*width, height: 0.25*height))
        ...
        strokePath11.addLine(to: CGPoint(x: 0.5875*width, y: 0.5875*height))
