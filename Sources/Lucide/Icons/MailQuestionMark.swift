...
internal struct MailQuestionMark: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.9166666667*width, y: 0.4375*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.6875*width, y: 0.8333333333*height))
        ...
        strokePath6.move(to: CGPoint(x: 0.75*width, y: 0.6366666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.7875*width, y: 0.595*height), control1: CGPoint(x: 0.7583333333*width, y: 0.62*height), control2: CGPoint(x: 0.7708333333*width, y: 0.6033333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.8958333333*width, y: 0.6116666667*height), control1: CGPoint(x: 0.8230485015*width, y: 0.574448119*height), control2: CGPoint(x: 0.8681061371*width, y: 0.581380063*height))
        strokePath6.addCurve(to: CGPoint(x: 0.9166666667*width, y: 0.6658333333*height), control1: CGPoint(x: 0.9083333333*width, y: 0.6283333333*height), control2: CGPoint(x: 0.9166666667*width, y: 0.645*height))
        strokePath6.addCurve(to: CGPoint(x: 0.8333333333*width, y: 0.7491666667*height), control1: CGPoint(x: 0.9166666667*width, y: 0.72*height), control2: CGPoint(x: 0.8333333333*width, y: 0.7491666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.8333333333*width, y: 0.9166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.8333333333*width, y: 0.9170833333*height))
