...
internal struct ChessRook: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.4166666667*width, y: 0.0833333333*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.7083333333*width, y: 0.75*height))
        strokePath8.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.375*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.25*width, y: 0.0833333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.25*width, y: 0.2916666667*height))
        strokePath10.addCurve(to: CGPoint(x: 0.3333333333*width, y: 0.375*height), control1: CGPoint(x: 0.25*width, y: 0.3376903958*height), control2: CGPoint(x: 0.2873096042*width, y: 0.375*height))
        strokePath10.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.375*height))
        strokePath10.addCurve(to: CGPoint(x: 0.75*width, y: 0.2916666667*height), control1: CGPoint(x: 0.7126903958*width, y: 0.375*height), control2: CGPoint(x: 0.75*width, y: 0.3376903958*height))
        strokePath10.addLine(to: CGPoint(x: 0.75*width, y: 0.0833333333*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.25*width, y: 0.1666666667*height))
        strokePath12.addLine(to: CGPoint(x: 0.75*width, y: 0.1666666667*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.2916666667*width, y: 0.75*height))
