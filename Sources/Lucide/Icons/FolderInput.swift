...
internal struct FolderInput: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.375*width, y: 0.6666666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.5*width, y: 0.5416666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.375*width, y: 0.4166666667*height))
