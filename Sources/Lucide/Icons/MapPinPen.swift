...
internal struct MapPinPen: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.74875*width, y: 0.3876666667*height))
        strokePath2.addCurve(to: CGPoint(x: 0.4021531663*width, y: 0.0834894394*height), control1: CGPoint(x: 0.7333051066*width, y: 0.2098236325*height), control2: CGPoint(x: 0.5804963125*width, y: 0.0757169391*height))
        strokePath2.addCurve(to: CGPoint(x: 0.0833333333*width, y: 0.4166666667*height), control1: CGPoint(x: 0.2238100202*width, y: 0.0912619397*height), control2: CGPoint(x: 0.0832476448*width, y: 0.238154252*height))
        strokePath2.addCurve(to: CGPoint(x: 0.3759166667*width, y: 0.8945*height), control1: CGPoint(x: 0.0833333333*width, y: 0.6120833333*height), control2: CGPoint(x: 0.2869583333*width, y: 0.8150833333*height))
        ...
        strokePath5.addEllipse(in: CGRect(x: 0.2916666667*width, y: 0.2916666667*height, width: 0.25*width, height: 0.25*height))
