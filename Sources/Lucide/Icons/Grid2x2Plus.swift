...
internal struct Grid2x2Plus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.4583333333*width, y: 0.875*height), control1: CGPoint(x: 0.5*width, y: 0.8563451979*height), control2: CGPoint(x: 0.4813451979*width, y: 0.875*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.8333333333*width, y: 0.5*height), control1: CGPoint(x: 0.875*width, y: 0.4813451979*height), control2: CGPoint(x: 0.8563451979*width, y: 0.5*height))
