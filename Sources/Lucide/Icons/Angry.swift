...
internal struct Angry: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.3125*width, y: 0.3333333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.4166666667*width, y: 0.375*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.5833333333*width, y: 0.375*height))
        strokePath7.addLine(to: CGPoint(x: 0.6875*width, y: 0.3333333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.375*width, y: 0.4166666667*height))
        strokePath9.addLine(to: CGPoint(x: 0.3754166667*width, y: 0.4166666667*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.625*width, y: 0.4166666667*height))
        strokePath11.addLine(to: CGPoint(x: 0.6254166667*width, y: 0.4166666667*height))
