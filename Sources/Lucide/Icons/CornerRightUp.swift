...
internal struct CornerRightUp: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.1666666667*width, y: 0.8333333333*height))
        strokePath4.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.8333333333*height))
        strokePath4.addCurve(to: CGPoint(x: 0.625*width, y: 0.6666666667*height), control1: CGPoint(x: 0.5503807916*width, y: 0.8333333333*height), control2: CGPoint(x: 0.625*width, y: 0.758714125*height))
