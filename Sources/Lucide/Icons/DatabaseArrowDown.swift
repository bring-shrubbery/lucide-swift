...
internal struct DatabaseArrowDown: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.5223333333*height))
        ...
        strokePath8.addCurve(to: CGPoint(x: 0.2868149843*width, y: 0.6028259561*height), control1: CGPoint(x: 0.1250098766*width, y: 0.541053077*height), control2: CGPoint(x: 0.1854933819*width, y: 0.5794875538*height))
        strokePath8.addCurve(to: CGPoint(x: 0.6325833333*width, y: 0.6169166667*height), control1: CGPoint(x: 0.3881365867*width, y: 0.6261643583*height), control2: CGPoint(x: 0.5173785222*width, y: 0.6314312103*height))
