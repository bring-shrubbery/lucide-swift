...
internal struct AlarmClockPlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath11.move(to: CGPoint(x: 0.5*width, y: 0.4166666667*height))
        ...
        strokePath13.move(to: CGPoint(x: 0.375*width, y: 0.5416666667*height))
        strokePath13.addLine(to: CGPoint(x: 0.625*width, y: 0.5416666667*height))
