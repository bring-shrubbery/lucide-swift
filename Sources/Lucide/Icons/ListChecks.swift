...
internal struct ListChecks: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath10.addLine(to: CGPoint(x: 0.2083333333*width, y: 0.375*height))
        strokePath10.addLine(to: CGPoint(x: 0.375*width, y: 0.2083333333*height))
