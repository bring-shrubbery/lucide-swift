...
internal struct Contact: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.375*width, y: 0.75*height), control1: CGPoint(x: 0.2916666667*width, y: 0.7873096042*height), control2: CGPoint(x: 0.3289762708*width, y: 0.75*height))
        strokePath4.addLine(to: CGPoint(x: 0.625*width, y: 0.75*height))
        strokePath4.addCurve(to: CGPoint(x: 0.7083333333*width, y: 0.8333333333*height), control1: CGPoint(x: 0.6710237292*width, y: 0.75*height), control2: CGPoint(x: 0.7083333333*width, y: 0.7873096042*height))
