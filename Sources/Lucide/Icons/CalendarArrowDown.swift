...
internal struct CalendarArrowDown: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.5833333333*width, y: 0.7083333333*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.875*width, y: 0.4314166667*height))
        ...
        strokePath8.addLine(to: CGPoint(x: 0.5142916667*width, y: 0.875*height))
