...
internal struct SquareBottomDashedScissors: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addLine(to: CGPoint(x: 0.6175*width, y: 0.6175*height))
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.875*width, y: 0.2083333333*height), control1: CGPoint(x: 0.8376903958*width, y: 0.125*height), control2: CGPoint(x: 0.875*width, y: 0.1623096042*height))
        ...
        strokePath10.move(to: CGPoint(x: 0.3983333333*width, y: 0.6016666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.2916666667*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath12 = Path()
        strokePath12.move(to: CGPoint(x: 0.3983333333*width, y: 0.3983333333*height))
        ...
        strokePath13.addEllipse(in: CGRect(x: 0.2916666667*width, y: 0.5833333333*height, width: 0.125*width, height: 0.125*height))
