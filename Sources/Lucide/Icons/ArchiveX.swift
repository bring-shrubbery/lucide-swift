...
internal struct ArchiveX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.3958333333*width, y: 0.7083333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.5*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.3958333333*width, y: 0.5*height))
        strokePath7.addLine(to: CGPoint(x: 0.6041666667*width, y: 0.7083333333*height))
