...
internal struct ArrowBigRightDash: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.4583333333*width, y: 0.375*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.5502916667*width, y: 0.82475*height))
        strokePath2.addCurve(to: CGPoint(x: 0.5181842653*width, y: 0.8311385586*height), control1: CGPoint(x: 0.5418665328*width, y: 0.8331776799*height), control2: CGPoint(x: 0.529193754*width, y: 0.8356992415*height))
        strokePath2.addCurve(to: CGPoint(x: 0.5*width, y: 0.8039166667*height), control1: CGPoint(x: 0.5071747766*width, y: 0.8265778756*height), control2: CGPoint(x: 0.4999974542*width, y: 0.8158334055*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.3333333333*width, y: 0.5833333333*height), control1: CGPoint(x: 0.3519881354*width, y: 0.625*height), control2: CGPoint(x: 0.3333333333*width, y: 0.6063451979*height))
        strokePath2.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.4166666667*height))
        strokePath2.addCurve(to: CGPoint(x: 0.375*width, y: 0.375*height), control1: CGPoint(x: 0.3333333333*width, y: 0.3936548021*height), control2: CGPoint(x: 0.3519881354*width, y: 0.375*height))
        strokePath2.closeSubpath()
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.1666666667*width, y: 0.375*height))
        strokePath4.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.625*height))
