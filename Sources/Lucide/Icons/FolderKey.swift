...
internal struct FolderKey: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.5416666667*width, y: 0.8333333333*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.39*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.7916666667*width, y: 0.5*height))
        ...
        strokePath7.addEllipse(in: CGRect(x: 0.7083333333*width, y: 0.75*height, width: 0.1666666667*width, height: 0.1666666667*height))
