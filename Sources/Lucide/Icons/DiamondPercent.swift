...
internal struct DiamondPercent: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.3833333333*width, y: 0.3833333333*height))
        strokePath4.addLine(to: CGPoint(x: 0.38375*width, y: 0.3833333333*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.6041666667*width, y: 0.3958333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.3958333333*width, y: 0.6041666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.6125*width, y: 0.6166666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.6129166667*width, y: 0.6166666667*height))
