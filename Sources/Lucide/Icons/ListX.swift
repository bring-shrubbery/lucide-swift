...
internal struct ListX: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.6458333333*width, y: 0.3958333333*height))
        strokePath8.addLine(to: CGPoint(x: 0.8541666667*width, y: 0.6041666667*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.8541666667*width, y: 0.3958333333*height))
        strokePath10.addLine(to: CGPoint(x: 0.6458333333*width, y: 0.6041666667*height))
