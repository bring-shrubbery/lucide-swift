...
internal struct BookImage: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.8333333333*width, y: 0.5708333333*height))
        strokePath2.addLine(to: CGPoint(x: 0.7458333333*width, y: 0.4833333333*height))
        strokePath2.addCurve(to: CGPoint(x: 0.6291666667*width, y: 0.4833333333*height), control1: CGPoint(x: 0.7134297075*width, y: 0.451571427*height), control2: CGPoint(x: 0.6615702925*width, y: 0.451571427*height))
        strokePath2.addLine(to: CGPoint(x: 0.4041666667*width, y: 0.7083333333*height))
        ...
        strokePath5.addEllipse(in: CGRect(x: 0.3333333333*width, y: 0.25*height, width: 0.1666666667*width, height: 0.1666666667*height))
