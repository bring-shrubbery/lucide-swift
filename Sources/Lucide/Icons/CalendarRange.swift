...
internal struct CalendarRange: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.2083333333*height))
        path.addPath(strokePath3.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath5 = Path()
        strokePath5.move(to: CGPoint(x: 0.125*width, y: 0.375*height))
        strokePath5.addLine(to: CGPoint(x: 0.875*width, y: 0.375*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.3333333333*width, y: 0.0833333333*height))
        strokePath7.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.2083333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.7083333333*width, y: 0.5416666667*height))
        strokePath9.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.5416666667*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.5416666667*width, y: 0.7083333333*height))
        strokePath11.addLine(to: CGPoint(x: 0.2916666667*width, y: 0.7083333333*height))
        ...
        strokePath13.move(to: CGPoint(x: 0.2916666667*width, y: 0.5416666667*height))
        strokePath13.addLine(to: CGPoint(x: 0.2920833333*width, y: 0.5416666667*height))
        ...
        strokePath15.move(to: CGPoint(x: 0.7083333333*width, y: 0.7083333333*height))
        strokePath15.addLine(to: CGPoint(x: 0.70875*width, y: 0.7083333333*height))
