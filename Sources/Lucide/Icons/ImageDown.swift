...
internal struct ImageDown: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.4291666667*width, y: 0.875*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.875*width, y: 0.625*height))
        strokePath2.addLine(to: CGPoint(x: 0.7458333333*width, y: 0.4958333333*height))
        strokePath2.addCurve(to: CGPoint(x: 0.6285833333*width, y: 0.4964166667*height), control1: CGPoint(x: 0.7131998918*width, y: 0.463849362*height), control2: CGPoint(x: 0.6608969188*width, y: 0.4641095758*height))
        strokePath2.addLine(to: CGPoint(x: 0.25*width, y: 0.875*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.5833333333*width, y: 0.7916666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.9166666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.6875*height))
