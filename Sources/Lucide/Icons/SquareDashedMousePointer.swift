...
internal struct SquareDashedMousePointer: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath12.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.875*height))
        ...
        strokePath18.move(to: CGPoint(x: 0.875*width, y: 0.375*height))
        ...
        strokePath20.move(to: CGPoint(x: 0.125*width, y: 0.5833333333*height))
        strokePath20.addLine(to: CGPoint(x: 0.125*width, y: 0.625*height))
