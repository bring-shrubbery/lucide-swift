...
internal struct Bolt: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.addEllipse(in: CGRect(x: 0.3333333333*width, y: 0.3333333333*height, width: 0.3333333333*width, height: 0.3333333333*height))
