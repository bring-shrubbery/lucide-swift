...
internal struct BluetoothOff: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.5*width, y: 0.0833333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.5*width, y: 0.2708333333*height))
