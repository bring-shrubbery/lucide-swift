...
internal struct ZoomOut: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath3.move(to: CGPoint(x: 0.3333333333*width, y: 0.4583333333*height))
        strokePath3.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.4583333333*height))
