...
internal struct FileChartLine: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.6666666667*width, y: 0.5416666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.5208333333*width, y: 0.6875*height))
        strokePath6.addLine(to: CGPoint(x: 0.4375*width, y: 0.6041666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.3333333333*width, y: 0.7083333333*height))
