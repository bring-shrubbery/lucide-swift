...
internal struct Trash: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.move(to: CGPoint(x: 0.7916666667*width, y: 0.25*height))
        ...
        strokePath4.move(to: CGPoint(x: 0.125*width, y: 0.25*height))
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.6666666667*width, y: 0.1666666667*height), control1: CGPoint(x: 0.6293570625*width, y: 0.0833333333*height), control2: CGPoint(x: 0.6666666667*width, y: 0.1206429375*height))
