...
internal struct RefreshCcwDot: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addCurve(to: CGPoint(x: 0.7808333333*width, y: 0.7608333333*height), control1: CGPoint(x: 0.6048353364*width, y: 0.8746056208*height), control2: CGPoint(x: 0.705459623*width, y: 0.8336990117*height))
