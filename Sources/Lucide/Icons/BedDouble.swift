...
internal struct BedDouble: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.0833333333*width, y: 0.8333333333*height))
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.9166666667*width, y: 0.5*height), control1: CGPoint(x: 0.8793570625*width, y: 0.4166666667*height), control2: CGPoint(x: 0.9166666667*width, y: 0.4539762708*height))
        strokePath2.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.8333333333*height))
        path.addPath(strokePath2.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath4 = Path()
        strokePath4.move(to: CGPoint(x: 0.1666666667*width, y: 0.4166666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.1666666667*width, y: 0.25*height))
        strokePath4.addCurve(to: CGPoint(x: 0.25*width, y: 0.1666666667*height), control1: CGPoint(x: 0.1666666667*width, y: 0.2039762708*height), control2: CGPoint(x: 0.2039762708*width, y: 0.1666666667*height))
