...
internal struct Sparkles: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.9166666667*width, y: 0.1666666667*height))
        strokePath6.addLine(to: CGPoint(x: 0.75*width, y: 0.1666666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.addEllipse(in: CGRect(x: 0.0833333333*width, y: 0.75*height, width: 0.1666666667*width, height: 0.1666666667*height))
