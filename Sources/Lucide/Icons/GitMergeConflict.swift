...
internal struct GitMergeConflict: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.75*width, y: 0.3333333333*height), control1: CGPoint(x: 0.7126903958*width, y: 0.25*height), control2: CGPoint(x: 0.75*width, y: 0.2873096042*height))
        ...
        strokePath6.move(to: CGPoint(x: 0.3541666667*width, y: 0.1458333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.1458333333*width, y: 0.3541666667*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.3541666667*width, y: 0.3541666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.1458333333*width, y: 0.1458333333*height))
