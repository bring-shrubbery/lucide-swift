...
internal struct BookCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.375*width, y: 0.3958333333*height))
        strokePath4.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.4791666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.625*width, y: 0.3125*height))
