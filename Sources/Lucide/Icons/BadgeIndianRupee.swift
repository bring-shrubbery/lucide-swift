...
internal struct BadgeIndianRupee: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.move(to: CGPoint(x: 0.5416666667*width, y: 0.7083333333*height))
        ...
        strokePath8.addCurve(to: CGPoint(x: 0.5416666667*width, y: 0.5*height), control1: CGPoint(x: 0.4670474583*width, y: 0.6666666667*height), control2: CGPoint(x: 0.5416666667*width, y: 0.5920474583*height))
        strokePath8.addCurve(to: CGPoint(x: 0.375*width, y: 0.3333333333*height), control1: CGPoint(x: 0.5416666667*width, y: 0.4079525417*height), control2: CGPoint(x: 0.4670474583*width, y: 0.3333333333*height))
