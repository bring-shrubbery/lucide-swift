...
internal struct MonitorCheck: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath7.move(to: CGPoint(x: 0.3333333333*width, y: 0.875*height))
        strokePath7.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.875*height))
