...
internal struct FileSignal: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addLine(to: CGPoint(x: 0.33375*width, y: 0.625*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.4791666667*width, y: 0.5625*height))
        strokePath8.addCurve(to: CGPoint(x: 0.4791666667*width, y: 0.6875*height), control1: CGPoint(x: 0.5069444444*width, y: 0.599537037*height), control2: CGPoint(x: 0.5069444444*width, y: 0.650462963*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.625*width, y: 0.5*height))
        strokePath10.addCurve(to: CGPoint(x: 0.625*width, y: 0.75*height), control1: CGPoint(x: 0.6805555556*width, y: 0.5740740741*height), control2: CGPoint(x: 0.6805555556*width, y: 0.6759259259*height))
