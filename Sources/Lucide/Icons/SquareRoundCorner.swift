...
internal struct SquareRoundCorner: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath2.addCurve(to: CGPoint(x: 0.5416666667*width, y: 0.125*height), control1: CGPoint(x: 0.875*width, y: 0.2742384167*height), control2: CGPoint(x: 0.7257615833*width, y: 0.125*height))
