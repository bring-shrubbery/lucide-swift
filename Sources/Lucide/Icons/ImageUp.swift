...
internal struct ImageUp: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.5833333333*width, y: 0.8125*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.6875*height))
