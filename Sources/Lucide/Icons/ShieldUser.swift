...
internal struct ShieldUser: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.move(to: CGPoint(x: 0.2656666667*width, y: 0.7879166667*height))
        strokePath4.addCurve(to: CGPoint(x: 0.5000642899*width, y: 0.6250315743*height), control1: CGPoint(x: 0.3020792037*width, y: 0.6899703389*height), control2: CGPoint(x: 0.3955685713*width, y: 0.6250037063*height))
        strokePath4.addCurve(to: CGPoint(x: 0.734375*width, y: 0.7880416667*height), control1: CGPoint(x: 0.6045600085*width, y: 0.6250594423*height), control2: CGPoint(x: 0.6980147108*width, y: 0.6900759311*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath5 = Path()
        strokePath5.addEllipse(in: CGRect(x: 0.3333333333*width, y: 0.2916666667*height, width: 0.3333333333*width, height: 0.3333333333*height))
