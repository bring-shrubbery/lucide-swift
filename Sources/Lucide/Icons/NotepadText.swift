...
internal struct NotepadText: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath7.addRoundedRect(in: CGRect(x: 0.1666666667*width, y: 0.1666666667*height, width: 0.6666666667*width, height: 0.75*height), cornerSize: CGSize(width: 0.0833333333*width, height: 0.0833333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.3333333333*width, y: 0.4166666667*height))
        strokePath9.addLine(to: CGPoint(x: 0.5833333333*width, y: 0.4166666667*height))
        ...
        strokePath11.addLine(to: CGPoint(x: 0.6666666667*width, y: 0.5833333333*height))
        ...
        strokePath13.move(to: CGPoint(x: 0.3333333333*width, y: 0.75*height))
        strokePath13.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.75*height))
