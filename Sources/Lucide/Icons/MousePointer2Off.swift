...
internal struct MousePointer2Off: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.6479166667*width, y: 0.3520833333*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.3520833333*width, y: 0.6479583333*height))
        ...
        strokePath6.move(to: CGPoint(x: 0.284*width, y: 0.4803333333*height))
        strokePath6.addLine(to: CGPoint(x: 0.1682083333*width, y: 0.1953333333*height))
        strokePath6.addCurve(to: CGPoint(x: 0.1725490229*width, y: 0.1725490229*height), control1: CGPoint(x: 0.1648432732*width, y: 0.1875673372*height), control2: CGPoint(x: 0.1665642787*width, y: 0.1785337671*height))
        strokePath6.addCurve(to: CGPoint(x: 0.1953333333*width, y: 0.1682083333*height), control1: CGPoint(x: 0.1785337671*width, y: 0.1665642787*height), control2: CGPoint(x: 0.1875673372*width, y: 0.1648432732*height))
        strokePath6.addLine(to: CGPoint(x: 0.4803333333*width, y: 0.284*height))
