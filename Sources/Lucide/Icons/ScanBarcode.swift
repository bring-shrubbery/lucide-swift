...
internal struct ScanBarcode: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath12.addLine(to: CGPoint(x: 0.5*width, y: 0.7083333333*height))
        ...
        strokePath14.move(to: CGPoint(x: 0.7083333333*width, y: 0.2916666667*height))
        strokePath14.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.7083333333*height))
