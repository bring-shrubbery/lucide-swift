...
internal struct Signpost: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.0980833333*width, y: 0.4314166667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.0833314771*width, y: 0.3958333333*height), control1: CGPoint(x: 0.0886385009*width, y: 0.4219833865*height), control2: CGPoint(x: 0.0833314771*width, y: 0.4091821773*height))
        strokePath6.addCurve(to: CGPoint(x: 0.0980833333*width, y: 0.36025*height), control1: CGPoint(x: 0.0833314771*width, y: 0.3824844894*height), control2: CGPoint(x: 0.0886385009*width, y: 0.3696832802*height))
        strokePath6.addLine(to: CGPoint(x: 0.1839166667*width, y: 0.2744166667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.2428333333*width, y: 0.25*height), control1: CGPoint(x: 0.1995410609*width, y: 0.2587875521*height), control2: CGPoint(x: 0.2207337655*width, y: 0.2500047198*height))
        strokePath6.addLine(to: CGPoint(x: 0.7571666667*width, y: 0.25*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.2428333333*width, y: 0.5416666667*height))
        strokePath6.addCurve(to: CGPoint(x: 0.1839166667*width, y: 0.51725*height), control1: CGPoint(x: 0.2207337655*width, y: 0.5416619469*height), control2: CGPoint(x: 0.1995410609*width, y: 0.5328791146*height))
