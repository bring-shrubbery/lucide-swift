...
internal struct Music4: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.addEllipse(in: CGRect(x: 0.125*width, y: 0.625*height, width: 0.25*width, height: 0.25*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.addEllipse(in: CGRect(x: 0.625*width, y: 0.5416666667*height, width: 0.25*width, height: 0.25*height))
