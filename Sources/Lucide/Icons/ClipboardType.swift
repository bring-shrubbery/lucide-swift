...
internal struct ClipboardType: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.375*width, y: 0.5*height))
        ...
        strokePath5.addLine(to: CGPoint(x: 0.625*width, y: 0.5*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.4583333333*width, y: 0.7083333333*height))
        strokePath7.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.7083333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.5*width, y: 0.4583333333*height))
        strokePath9.addLine(to: CGPoint(x: 0.5*width, y: 0.7083333333*height))
