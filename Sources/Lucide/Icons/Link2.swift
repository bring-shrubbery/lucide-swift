...
internal struct Link2: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath4.addCurve(to: CGPoint(x: 0.9166666667*width, y: 0.5*height), control1: CGPoint(x: 0.8233926562*width, y: 0.2916666667*height), control2: CGPoint(x: 0.9166666667*width, y: 0.3849406771*height))
        strokePath4.addCurve(to: CGPoint(x: 0.7083333333*width, y: 0.7083333333*height), control1: CGPoint(x: 0.9166666667*width, y: 0.6150593229*height), control2: CGPoint(x: 0.8233926562*width, y: 0.7083333333*height))
