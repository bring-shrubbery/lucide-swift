...
internal struct Move3d: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.2083333333*width, y: 0.125*height))
        ...
        strokePath4.move(to: CGPoint(x: 0.2083333333*width, y: 0.7916666667*height))
        strokePath4.addLine(to: CGPoint(x: 0.4583333333*width, y: 0.5416666667*height))
        path.addPath(strokePath4.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath6 = Path()
        strokePath6.move(to: CGPoint(x: 0.0833333333*width, y: 0.25*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.75*width, y: 0.6666666667*height))
