...
internal struct FoldVertical: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath14.addLine(to: CGPoint(x: 0.5*width, y: 0.6666666667*height))
        ...
        strokePath16.addLine(to: CGPoint(x: 0.5*width, y: 0.3333333333*height))
