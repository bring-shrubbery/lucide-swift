...
internal struct BanknoteArrowUp: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addLine(to: CGPoint(x: 0.7916666667*width, y: 0.6666666667*height))
        ...
        strokePath11.addEllipse(in: CGRect(x: 0.4166666667*width, y: 0.4166666667*height, width: 0.1666666667*width, height: 0.1666666667*height))
