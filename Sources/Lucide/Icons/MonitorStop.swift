...
internal struct MonitorStop: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.addRoundedRect(in: CGRect(x: 0.375*width, y: 0.2916666667*height, width: 0.25*width, height: 0.25*height), cornerSize: CGSize(width: 0.0416666667*width, height: 0.0416666667*height))
