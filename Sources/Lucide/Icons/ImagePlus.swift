...
internal struct ImagePlus: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath6.move(to: CGPoint(x: 0.875*width, y: 0.4791666667*height))
        ...
        strokePath6.addLine(to: CGPoint(x: 0.5208333333*width, y: 0.125*height))
        path.addPath(strokePath6.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath8 = Path()
        strokePath8.move(to: CGPoint(x: 0.875*width, y: 0.625*height))
        strokePath8.addLine(to: CGPoint(x: 0.7464166667*width, y: 0.4964166667*height))
        strokePath8.addCurve(to: CGPoint(x: 0.6285833333*width, y: 0.4964166667*height), control1: CGPoint(x: 0.7138750124*width, y: 0.4638848385*height), control2: CGPoint(x: 0.6611249876*width, y: 0.4638848385*height))
        strokePath8.addLine(to: CGPoint(x: 0.25*width, y: 0.875*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.addEllipse(in: CGRect(x: 0.2916666667*width, y: 0.2916666667*height, width: 0.1666666667*width, height: 0.1666666667*height))
