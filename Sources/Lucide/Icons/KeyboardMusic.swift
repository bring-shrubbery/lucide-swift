...
internal struct KeyboardMusic: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath5.move(to: CGPoint(x: 0.5833333333*width, y: 0.3333333333*height))
        strokePath5.addLine(to: CGPoint(x: 0.58375*width, y: 0.3333333333*height))
        path.addPath(strokePath5.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath7 = Path()
        strokePath7.move(to: CGPoint(x: 0.75*width, y: 0.3333333333*height))
        strokePath7.addLine(to: CGPoint(x: 0.7504166667*width, y: 0.3333333333*height))
        path.addPath(strokePath7.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath9 = Path()
        strokePath9.move(to: CGPoint(x: 0.0833333333*width, y: 0.5*height))
        strokePath9.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.5*height))
        ...
        strokePath11.move(to: CGPoint(x: 0.25*width, y: 0.5*height))
        strokePath11.addLine(to: CGPoint(x: 0.25*width, y: 0.6666666667*height))
        ...
        strokePath13.move(to: CGPoint(x: 0.4166666667*width, y: 0.5*height))
        strokePath13.addLine(to: CGPoint(x: 0.4166666667*width, y: 0.6666666667*height))
        ...
        strokePath15.move(to: CGPoint(x: 0.5833333333*width, y: 0.5*height))
        ...
        strokePath17.move(to: CGPoint(x: 0.75*width, y: 0.5*height))
        strokePath17.addLine(to: CGPoint(x: 0.75*width, y: 0.6666666667*height))
