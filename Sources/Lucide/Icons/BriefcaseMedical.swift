...
internal struct BriefcaseMedical: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath8.addLine(to: CGPoint(x: 0.75*width, y: 0.8333333333*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.25*width, y: 0.25*height))
        strokePath10.addLine(to: CGPoint(x: 0.25*width, y: 0.8333333333*height))
        path.addPath(strokePath10.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath11 = Path()
        strokePath11.addRoundedRect(in: CGRect(x: 0.0833333333*width, y: 0.25*height, width: 0.8333333333*width, height: 0.5833333333*height), cornerSize: CGSize(width: 0.0833333333*width, height: 0.0833333333*height))
