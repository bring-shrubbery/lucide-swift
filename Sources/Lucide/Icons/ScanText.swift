...
internal struct ScanText: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath10.move(to: CGPoint(x: 0.2916666667*width, y: 0.3333333333*height))
        ...
        strokePath12.addLine(to: CGPoint(x: 0.7083333333*width, y: 0.5*height))
        ...
        strokePath14.addLine(to: CGPoint(x: 0.5416666667*width, y: 0.6666666667*height))
