...
internal struct CreditCardX: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let width = rect.size.width
        let height = rect.size.height
        var strokePath2 = Path()
        strokePath2.move(to: CGPoint(x: 0.5208333333*width, y: 0.7916666667*height))
        ...
        strokePath2.addLine(to: CGPoint(x: 0.9166666667*width, y: 0.4375*height))
        ...
        strokePath8.move(to: CGPoint(x: 0.6875*width, y: 0.6041666667*height))
        strokePath8.addLine(to: CGPoint(x: 0.8958333333*width, y: 0.8125*height))
        path.addPath(strokePath8.strokedPath(StrokeStyle(lineWidth: 0.0833333333*width, lineCap: .round, lineJoin: .round, miterLimit: 4)))
        var strokePath10 = Path()
        strokePath10.move(to: CGPoint(x: 0.8958333333*width, y: 0.6041666667*height))
        strokePath10.addLine(to: CGPoint(x: 0.6875*width, y: 0.8125*height))
