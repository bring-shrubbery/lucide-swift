...
internal struct ScanSquare: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        strokePath9.addRoundedRect(in: CGRect(x: 0.3333333333*width, y: 0.3333333333*height, width: 0.3333333333*width, height: 0.3333333333*height), cornerSize: CGSize(width: 0.0416666667*width, height: 0.0416666667*height))
